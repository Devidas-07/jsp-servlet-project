...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="container text-center mt-5">
        ...
        <p>Keep track of your daily activities, manage your tasks, and never miss a reminder.</p>
        <p>Features:</p>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="2000">
      <img src="C:\FSD24APR\JAVA\Java Program\SERVLET\online-diary-with-jsp-servlet\src\main\webapp\online-dairy1.jpg" class="d-block w-100" alt="...">
    </div>
